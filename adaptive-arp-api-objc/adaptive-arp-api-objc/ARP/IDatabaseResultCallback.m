...
ARPIDatabaseResultCallback_WarningEnum *ARPIDatabaseResultCallback_WarningEnum_values[3];
...
+ (void)initialize {
  if (self == [ARPIDatabaseResultCallback_WarningEnum class]) {
    ...
    ARPIDatabaseResultCallback_WarningEnum_Unknown = [[ARPIDatabaseResultCallback_WarningEnum alloc] initWithNSString:@"Unknown" withInt:2];
    ARPIDatabaseResultCallback_WarningEnum_initialized = YES;
  }
}

+ (IOSObjectArray *)values {
  return [IOSObjectArray arrayWithObjects:ARPIDatabaseResultCallback_WarningEnum_values count:3 type:[IOSClass classWithClass:[ARPIDatabaseResultCallback_WarningEnum class]]];
}
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcFieldInfo fields[] = {
    ...
    { "Unknown", "Unknown", 0x4019, "Lme.adaptive.arp.api.IDatabaseResultCallback$Warning;", &ARPIDatabaseResultCallback_WarningEnum_Unknown,  },
  };
  static const char *superclass_type_args[] = {"Lme.adaptive.arp.api.IDatabaseResultCallback$Warning;"};
  static J2ObjcClassInfo _ARPIDatabaseResultCallback_WarningEnum = { "Warning", "me.adaptive.arp.api", "IDatabaseResultCallback", 0x4019, 1, methods, 3, fields, 1, superclass_type_args};
...
ARPIDatabaseResultCallback_ErrorEnum *ARPIDatabaseResultCallback_ErrorEnum_values[4];
...
+ (void)initialize {
  if (self == [ARPIDatabaseResultCallback_ErrorEnum class]) {
    ...
    ARPIDatabaseResultCallback_ErrorEnum_Unknown = [[ARPIDatabaseResultCallback_ErrorEnum alloc] initWithNSString:@"Unknown" withInt:3];
    ARPIDatabaseResultCallback_ErrorEnum_initialized = YES;
  }
}

+ (IOSObjectArray *)values {
  return [IOSObjectArray arrayWithObjects:ARPIDatabaseResultCallback_ErrorEnum_values count:4 type:[IOSClass classWithClass:[ARPIDatabaseResultCallback_ErrorEnum class]]];
}
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcFieldInfo fields[] = {
    ...
    { "Unknown", "Unknown", 0x4019, "Lme.adaptive.arp.api.IDatabaseResultCallback$Error;", &ARPIDatabaseResultCallback_ErrorEnum_Unknown,  },
  };
  static const char *superclass_type_args[] = {"Lme.adaptive.arp.api.IDatabaseResultCallback$Error;"};
  static J2ObjcClassInfo _ARPIDatabaseResultCallback_ErrorEnum = { "Error", "me.adaptive.arp.api", "IDatabaseResultCallback", 0x4019, 1, methods, 4, fields, 1, superclass_type_args};
