...
#ifndef _ARPIAppServerManager_H_
#define _ARPIAppServerManager_H_
...
__attribute__((always_inline)) inline void ARPIAppServerManager_init() {}

#define MeAdaptiveArpApiIAppServerManager ARPIAppServerManager

#endif // _ARPIAppServerManager_H_
