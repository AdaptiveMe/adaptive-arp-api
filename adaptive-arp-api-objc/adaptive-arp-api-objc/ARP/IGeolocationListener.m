...
ARPIGeolocationListener_ErrorEnum *ARPIGeolocationListener_ErrorEnum_values[5];
...
+ (void)initialize {
  if (self == [ARPIGeolocationListener_ErrorEnum class]) {
    ...
    ARPIGeolocationListener_ErrorEnum_Unknown = [[ARPIGeolocationListener_ErrorEnum alloc] initWithNSString:@"Unknown" withInt:4];
    ARPIGeolocationListener_ErrorEnum_initialized = YES;
  }
}

+ (IOSObjectArray *)values {
  return [IOSObjectArray arrayWithObjects:ARPIGeolocationListener_ErrorEnum_values count:5 type:[IOSClass classWithClass:[ARPIGeolocationListener_ErrorEnum class]]];
}
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcFieldInfo fields[] = {
    ...
    { "Unknown", "Unknown", 0x4019, "Lme.adaptive.arp.api.IGeolocationListener$Error;", &ARPIGeolocationListener_ErrorEnum_Unknown,  },
  };
  static const char *superclass_type_args[] = {"Lme.adaptive.arp.api.IGeolocationListener$Error;"};
  static J2ObjcClassInfo _ARPIGeolocationListener_ErrorEnum = { "Error", "me.adaptive.arp.api", "IGeolocationListener", 0x4019, 1, methods, 5, fields, 1, superclass_type_args};
...
ARPIGeolocationListener_WarningEnum *ARPIGeolocationListener_WarningEnum_values[3];
...
+ (void)initialize {
  if (self == [ARPIGeolocationListener_WarningEnum class]) {
    ...
    ARPIGeolocationListener_WarningEnum_Unknown = [[ARPIGeolocationListener_WarningEnum alloc] initWithNSString:@"Unknown" withInt:2];
    ARPIGeolocationListener_WarningEnum_initialized = YES;
  }
}

+ (IOSObjectArray *)values {
  return [IOSObjectArray arrayWithObjects:ARPIGeolocationListener_WarningEnum_values count:3 type:[IOSClass classWithClass:[ARPIGeolocationListener_WarningEnum class]]];
}
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcFieldInfo fields[] = {
    ...
    { "Unknown", "Unknown", 0x4019, "Lme.adaptive.arp.api.IGeolocationListener$Warning;", &ARPIGeolocationListener_WarningEnum_Unknown,  },
  };
  static const char *superclass_type_args[] = {"Lme.adaptive.arp.api.IGeolocationListener$Warning;"};
  static J2ObjcClassInfo _ARPIGeolocationListener_WarningEnum = { "Warning", "me.adaptive.arp.api", "IGeolocationListener", 0x4019, 1, methods, 3, fields, 1, superclass_type_args};
