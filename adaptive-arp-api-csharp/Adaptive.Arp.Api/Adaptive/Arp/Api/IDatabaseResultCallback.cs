...
{
	public abstract class IDatabaseResultCallback : IBaseCallback
	{
		...
		/// <since>ARP1.0</since>
		public abstract void OnResult(Database database);
		...
		/// <author>Ferran Vila Conesa</author>
		/// <since>ARP1.0</since>
		public abstract void OnWarning(Database database, IDatabaseResultCallback.Warning
			 warning);
