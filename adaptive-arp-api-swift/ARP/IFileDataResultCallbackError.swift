...
*  IFileDataResultCallbackError.swift
...
public enum IFileDataResultCallbackError {
     ...
     /// Enum Values
     case InexistentFile, InsufficientSpace, Unauthorized, Unknown
     ...
     /// toEnum
     public static func toEnum(string:String?) -> IFileDataResultCallbackError {
