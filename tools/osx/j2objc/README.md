...
1. Ensure you have ```wget```, ```unzip``` available as commands on bash. If not, download them with **MacPorts** or **Brew** and install them.
...
6. That's all folks! You should have .o in the "tmp.out" directory.
